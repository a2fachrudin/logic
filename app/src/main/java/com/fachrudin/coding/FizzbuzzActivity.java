...
public class FizzbuzzActivity extends AppCompatActivity {
    ...
    private void createListView() {
        ...
        for (int i = 1; i <= 100; i++) {
            ...
            if (i % 3 == 0 && i % 5 == 0) {
                myItems.add(new MyItem(indexNumber, "FizzBuzz")); //add Data
            } else if (i % 3 == 0) {
                myItems.add(new MyItem(indexNumber, "Fizz"));
            } else if (i % 5 == 0) {
                myItems.add(new MyItem(indexNumber, "Buzz"));
            } else {
                myItems.add(new MyItem(indexNumber, indexNumber));
            }
        }
